...
class Sentence:
    ...
    def mark_safe(self, cell):
        """
        Updates internal knowled  representation given the fact that
    ...
    def add_knowledge(self, cell, count):
        ...
        for s1, s2 in itertools.combinations(self.knowledge, 2):
            ...
            if s1.cells.issubset(s2.cells):
                ...
                s3 = Sentence(s1.cells - s2.cells, s1.count - s2.count)
            if s3 and s3 not in self.knowledge:
                new.append(s3)

        self.knowledge = self.knowledge + new
